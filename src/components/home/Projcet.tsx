...
const Project = ({ projects }: { projects: IProduct[] }) => {
  ...
  return (
    <div className="lg:py-14 py-10 text-white xl:px-24 md:px-6 px-4">
        ...
        {projects?.map((project) => (
          ...
          >
            ...
            <div className="mt-4 px-3 py-4">
              ...
              <p className="text-gray-300 mt-2 text-sm">{project?.about.slice(0,150)}</p>

              {/* Details Button */}
              <div className="flex mt-5 mb-4 items-center gap-4 text-3xl">
