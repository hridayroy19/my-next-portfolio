...
const Skills = ({ technology }: { technology: ITechnology[] }) => {
  ...
  return (
    <div className="bg-[#0e1423]/90">
      <section
        id="skill"
        className="py-16 sm:py-20 px-4 sm:px-6 md:px-8 xl:px-20 overflow-hidden"
      >
        <div className="max-w-7xl mx-auto">
          {/* Title */}
          <h2 className="text-center uppercase font-bold text-white text-3xl sm:text-4xl lg:text-5xl mb-12 tracking-widest">
            Tech Stack
          </h2>
